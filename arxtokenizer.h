...
enum tokenType {
    ...
    comma,                // 15 | enhanced: parameter separator
...
const char *tokenTypeToStr(enum tokenType d_type) {
    switch (d_type) {
        ...
        case comma:        return "comma";           // apparently this is needed
        ...
        case _subprog:     return "_subprog"; // func call
...
// tokenizer functions (cant extern functions)
...
int findMatchingBracket(int startPos, enum tokenType openBracket, enum tokenType closeBracket);
